...
comp = pd.read_csv(
    "C:/thesis_code/Github/Experiments/data/manual_1860_1850_1")
latest = pd.read_csv(
    "C:/thesis_code/Github/Experiments/data/manual_1860_1850_pa_id/1860", usecols=['pa_id1'])
earliest = pd.read_csv(
    "C:/thesis_code/Github/Experiments/data/manual_1860_1850_pa_id/1850", usecols=['pa_id2'])
...
def merge_pa_id(df, latest, earliest):
    ...
    df2 = df1.merge(earliest, how='left',
                    left_on='Unnamed: 1', right_index=True, suffixes=('_1860', '_1850'))
    ...
    df2.to_csv(
        "C:/thesis_code/Github/Experiments/data/manual_1860_1850", index=False)
    return df2
