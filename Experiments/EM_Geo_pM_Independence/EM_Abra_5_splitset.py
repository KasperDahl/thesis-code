...
# dataset = pd.read_csv(
#     "C:/thesis_code/Github/Experiments/data/splitset/1850_1845_females")

# # 1850-1845 Above age - Match guess 5,200
# dataset = pd.read_csv(
#     "C:/thesis_code/Github/Experiments/data/splitset/1850_1845_above_age")

# # 1850-1845 Below age - Match guess 5,200
# dataset = pd.read_csv(
#     "C:/thesis_code/Github/Experiments/data/splitset/1850_1845_below_age")
...
class ExpectationMaximization:
    ...
    def evaluation_bayes(self, data, results, data_b, path):
        ...
        data_b.to_csv(
            f"C:/thesis_code/Github/Experiments/results_after_EM/Splitset/{path}", index=False)
        f = open(
            "C:/thesis_code/Github/Experiments/results_after_EM/Splitset/p_values.txt", "a")
